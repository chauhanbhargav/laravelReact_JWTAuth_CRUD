jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    if (!t.jQuery) {
        ...
        n.isWindow = function (t) {
            ...
            if (i) {
                if (o)for (; r > a && n.apply(t[a], i) !== !1; a++); else for (a in t)if (n.apply(t[a], i) === !1)break
            } else if (o)for (; r > a && n.call(t[a], a, t[a]) !== !1; a++); else for (a in t)if (n.call(t[a], a, t[a]) === !1)break;
            return t
            ...
            var t, e, i, a, r, o, s = arguments[0] || {}, l = 1, u = arguments.length, d = !1;
            for ("boolean" == typeof s && (d = s, s = arguments[l] || {}, l++), "object" != typeof s && "function" !== n.type(s) && (s = {}), l === u && (s = this, l--); u > l; l++)if (null != (r = arguments[l]))for (a in r)t = s[a], i = r[a], s !== i && (d && i && (n.isPlainObject(i) || (e = n.isArray(i))) ? (e ? (e = !1, o = t && n.isArray(t) ? t : []) : o = t && n.isPlainObject(t) ? t : {}, s[a] = n.extend(d, o, i)) : void 0 !== i && (s[a] = i));
            return s
    ...
    return function (t, e, n, i) {
        ...
        function l(t, n, i, a) {
            ...
            function f(e) {
                ...
                --a;
                var o = (e - S[a]) / (S[a + 1] - S[a]), s = n + o * x, l = u(s, t, i);
            ...
            var g = 4, m = .001, v = 1e-7, b = 10, y = 11, x = 1 / (y - 1), w = "Float32Array" in e;
            if (4 !== arguments.length)return !1;
            for (var k = 0; 4 > k; ++k)if ("number" != typeof arguments[k] || isNaN(arguments[k]) || !isFinite(arguments[k]))return !1;
            t = Math.min(t, 1), i = Math.min(i, 1), t = Math.max(t, 0), i = Math.max(i, 0);
            var S = w ? new Float32Array(y) : new Array(y), C = !1, M = function (e) {
        ...
        function d(t) {
            if (t) {
                ...
                for (var r = 0; n > r; r++)if (y.State.calls[r]) {
                    var s = y.State.calls[r], l = s[0], u = s[2], f = s[3], p = !!f, m = null;
                    ...
                    for (var v = Math.min((e - f) / u.duration, 1), b = 0, x = l.length; x > b; b++) {
                        ...
                        if (o(C)) {
                            ...
                            for (var A in k)if ("element" !== A) {
                                var I, _ = k[A], T = g.isString(_.easing) ? y.Easings[_.easing] : _.easing;
                                if (1 === v) I = _.endValue; else {
                                ...
                                if (_.currentValue = I, "tween" === A) m = I; else {
                                    if (w.Hooks.registered[A]) {
                                        var V = w.Hooks.getRoot(A), F = o(C).rootPropertyValueCache[V];
        ...
        function c(t, e) {
            ...
            for (var n = y.State.calls[t][0], a = y.State.calls[t][1], r = y.State.calls[t][2], s = y.State.calls[t][4], l = !1, u = 0, d = n.length; d > u; u++) {
                ...
                if (e || r.loop || ("none" === r.display && w.setPropertyValue(c, "display", r.display), "hidden" === r.visibility && w.setPropertyValue(c, "visibility", r.visibility)), r.loop !== !0 && (h.queue(c)[1] === i || !/\.velocityQueueEntryFlag/i.test(h.queue(c)[1])) && o(c)) {
                    ...
                    h.each(w.Lists.transforms3D, function (t, e) {
                        var n = /^scale/.test(e) ? 1 : 0, a = o(c).transformCache[e];
            ...
            y.State.calls[t] = !1;
            for (var p = 0, g = y.State.calls.length; g > p; p++)if (y.State.calls[p] !== !1) {
                l = !0;
                break
            }
        ...
        var w = y.CSS = {
            ...
            Hooks: {
                templates: {
                    ...
                    var n, i, a;
                    if (f)for (n in w.Hooks.templates) {
                    ...
                    for (var t = 0; t < w.Lists.colors.length; t++)!function () {
                        ...
                        w.Normalizations.registered[e] = function (t, n, a) {
                            switch (t) {
                                ...
                                case"extract":
                                    var r;
                                    if (w.RegEx.wrappedValueAlreadyExtracted.test(a)) r = a; else {
                                        var o, s = {
                                            black: "rgb(0, 0, 0)",
                                            blue: "rgb(0, 0, 255)",
            ...
            getPropertyValue: function (t, n, a, r) {
                ...
                if (!/^[\d-]/.test(l))if (o(t) && o(t).isSVG && w.Names.SVGAttribute(n))if (/^(height|width)$/i.test(n))try {
                    l = t.getBBox()[n]
                } catch (t) {
                    l = 0
            ...
            setPropertyValue: function (t, n, i, a, r) {
                var s = n;
                if ("scroll" === n) r.container ? r.container["scroll" + r.direction] = i : "Left" === r.direction ? e.scrollTo(i, r.alternateValue) : e.scrollTo(r.alternateValue, i); else if (w.Normalizations.registered[n] && "transform" === w.Normalizations.registered[n]("name", t)) w.Normalizations.registered[n]("inject", t, i), s = "transform", i = o(t).transformCache[n]; else {
                    if (w.Hooks.registered[n]) {
        ...
        var k = function () {
            ...
            function a() {
                function t(t) {
                    ...
                    if ("scroll" === I) {
                        var v, x, k, M = /^x$/i.test(s.axis) ? "Left" : "Top", P = parseFloat(s.offset) || 0;
                        s.container ? g.isWrapped(s.container) || g.isNode(s.container) ? (s.container = s.container[0] || s.container, v = s.container["scroll" + M], k = v + h(r).position()[M.toLowerCase()] + P) : s.container = null : (v = y.State.scrollAnchor[y.State["scrollProperty" + M]], x = y.State.scrollAnchor[y.State["scrollProperty" + ("Left" === M ? "Top" : "Left")]], k = h(r).offset()[M.toLowerCase()] + P), l = {
                            scroll: {
                                ...
                                unitType: "",
                                easing: s.easing,
                                scrollData: {container: s.container, direction: M, alternateValue: x}
                            }, element: r
                        ...
                        for (var V in m) {
                            var F = c(m[V]), R = F[0], W = F[1], E = F[2];
                            V = w.Names.camelCase(V);
                            var B = w.Hooks.getRoot(V), z = !1;
                ...
                var a, r = this, s = h.extend({}, y.defaults, b), l = {};
            ...
            var s, l, f, p, m, b,
                x = arguments[0] && (arguments[0].p || h.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || g.isString(arguments[0].properties));
            if (g.isWrapped(this) ? (s = !1, f = 0, p = this, l = this) : (s = !0, f = 1, p = x ? arguments[0].elements || arguments[0].e : arguments[0]), p = r(p)) {
                    ...
                    default:
                        if (!h.isPlainObject(m) || g.isEmptyObject(m)) {
                            if (g.isString(m) && y.Redirects[m]) {
                                var T = h.extend({}, b), D = T.duration, V = T.delay || 0;
                ...
                if (T.loop = parseInt(T.loop), R = 2 * T.loop - 1, T.loop)for (var W = 0; R > W; W++) {
                    var E = {delay: T.delay, progress: T.progress};
        ...
        return y.State.isMobile || n.hidden === i || n.addEventListener("visibilitychange", function () {
            ...
            y.Redirects["slide" + e] = function (t, n, a, r, o, s) {
                var l = h.extend({}, n), u = l.begin, d = l.complete,
            ...
            y.Redirects["fade" + e] = function (t, n, a, r, o, s) {
                var l = h.extend({}, n), u = {opacity: "In" === e ? 1 : 0}, d = l.complete;
    ...
    return function t(e, n, i) {
        ...
        1: [function (t, e, n) {
            ...
            function i(t) {
                if (t) {
                    var e = [0, 0, 0], n = 1, i = t.match(/^#([a-fA-F0-9]{3})$/);
                    if (i) {
                        i = i[1];
                ...
                t.defaults.bar = {
                    ...
                    dataElementType: t.elements.Rectangle, initialize: function () {
                        ...
                        var n, i, a, r, o, s, l = this, u = l.chart, d = l.getMeta(), c = l.getValueScale(),
                            h = u.data.datasets, f = Number(h[t].data[e]), p = c.options.stacked, g = d.stack, m = 0;
                        if (p || void 0 === p && void 0 !== g)for (n = 0; n < t; ++n)i = u.getDatasetMeta(n), i.bar && i.stack === g && i.controller.getValueScaleId() === c.id && u.isDatasetVisible(n) && (a = Number(h[n].data[e]), (f < 0 && a < 0 || f >= 0 && a > 0) && (m += a));
                ...
                n.doughnut = {
                    ...
                    updateElement: function (t, n, i) {
                        var a = this, r = a.chart, o = r.chartArea, s = r.options, l = s.animation,
                            ...
                            g = i && l.animateScale ? 0 : a.innerRadius, m = i && l.animateScale ? 0 : a.outerRadius,
                ...
                t.defaults.line = {
                    ...
                    updateElement: function (t, e, i) {
                        var a, r, o = this, s = o.getMeta(), l = t.custom || {}, u = o.getDataset(), d = o.index,
                            ...
                            p = o.chart.options.elements.point, g = o.chart.data.labels || [],
            ...
            e.exports = function (t) {
                ...
                t.defaults.polarArea = {
                    ...
                    updateElement: function (t, n, i) {
                        ...
                        var b = s.startAngle, y = t.hidden ? 0 : u.getDistanceFromCenterForValue(o.data[n]),
                            x = b + h * g, w = x + (t.hidden ? 0 : h),
                    ...
                    if (!(isNaN(i) || i <= 0)) {
                        switch (n) {
                            ...
                            case"rect":
                                ...
                                break;
                            case"rectRounded":
                                var h = i / Math.SQRT2, f = a - h, p = r - h, g = Math.SQRT2 * i;
            ...
            e.exports = function (t) {
                function e(t, e, n, a) {
                    ...
                    for (r = 0, o = p.length; r < o; ++r)if (s = p[r], d = n[s], e.hasOwnProperty(s) || (e[s] = d), (l = e[s]) !== d && "_" !== s[0]) {
                    ...
                    defaults: {}, addBox: function (t, e) {
                        ...
                        function s(t) {
                            ...
                            if (e)if (t.isHorizontal()) {
                                var n = {left: Math.max(L, T), right: Math.max(O, D), top: 0, bottom: 0};
                        ...
                        if (t) {
                            var d = t.options.layout, c = d ? d.padding : null, h = 0, f = 0, p = 0, g = 0;
                            ...
                            var m = e(t.boxes, "left"), v = e(t.boxes, "right"), b = e(t.boxes, "top"),
                                y = e(t.boxes, "bottom"), x = e(t.boxes, "chartArea");
                            n(m, !0), n(v, !1), n(b, !0), n(y, !1);
                            var w = a - h - f, k = r - p - g, S = w / 2, C = k / 2, M = (a - S) / (m.length + v.length),
                                P = (r - C) / (b.length + y.length), A = w, I = k, _ = [];
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.plugins = {}, t.plugins = {
                    _plugins: [], _cacheId: 0, register: function (t) {
                        ...
                        for (i = 0; i < u; ++i)if (a = l[i], r = a.plugin, "function" == typeof(s = r[e]) && (o = [t].concat(n || []), o.push(a.options), s.apply(r, o) === !1))return !1;
                        return !0
            ...
            e.exports = function (t) {
                ...
                t.defaults.scale = {
                    ...
                    calculateTickRotation: function () {
                        ...
                        if (t.options.display && t.isHorizontal())for (var s, l = i.longestText(e, r.font, t.ticks, t.longestTextCache), u = l, d = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; u > d && o < a.maxRotation;) {
                            var c = i.toRadians(o);
                    ...
                    fit: function () {
                        ...
                        if (a.width = d ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : u && l.drawTicks ? f : 0, a.height = d ? u && l.drawTicks ? f : 0 : t.maxHeight, s.display && u && (d ? a.height += h : a.width += h), o.display && u) {
                            var p = i.longestText(t.ctx, c.font, t.ticks, t.longestTextCache),
                                g = i.numberOfLabelLines(t.ticks), m = .5 * c.size;
                            if (d) {
                                t.longestLabelWidth = p;
                                var v = i.toRadians(t.labelRotation), b = Math.cos(v), y = Math.sin(v),
                                    x = y * p + c.size * g + m * g;
                                a.height = Math.min(t.maxHeight, a.height + x), t.ctx.font = c.font;
                                var w = t.ticks[0], k = e(t.ctx, w, c.font), S = t.ticks[t.ticks.length - 1],
                                    C = e(t.ctx, S, c.font);
                    ...
                    draw: function (e) {
                        ...
                        if (r.display) {
                            ...
                            var m = i.getValueOrDefault(d.fontColor, u.defaultFontColor), v = n(d),
                                ...
                                y = i.getValueOrDefault(h.fontColor, u.defaultFontColor), x = n(h),
                                w = i.toRadians(a.labelRotation), k = Math.cos(w), S = a.longestLabelWidth * k;
                            l.fillStyle = m;
                            var C = [];
                            if (g) {
                            ...
                            if (i.each(a.ticks, function (t, n) {
                                    if (void 0 !== t && null !== t) {
                                        ...
                                        if ((!(o > 1 && n % o > 0 || n % o == 0 && n + o >= a.ticks.length) || s) && void 0 !== t && null !== t) {
                                            ...
                                            var v, y, x, k, S, _, T, D, V, F, L = "middle", O = "middle";
                                            if (g) {
                                                ...
                                                var W, E = "left" === r.position, B = d.padding;
                                ...
                                var _, T, D = 0;
                                if (g) _ = a.left + (a.right - a.left) / 2, T = "bottom" === r.position ? a.bottom - x.size / 2 : a.top + x.size / 2; else {
                            ...
                            if (c.drawBorder) {
                                ...
                                var F = a.left, L = a.right, O = a.top, R = a.bottom, W = i.aliasPixel(l.lineWidth);
            ...
            e.exports = function (t) {
                ...
                function o(t, e) {
                    ...
                    var p = t._options;
                    return {xAlign: p.xAlign ? p.xAlign : r, yAlign: p.yAlign ? p.yAlign : o}
                }
                ...
                t.defaults.global.tooltips = {
                    ...
                    initialize: function () {
                        ...
                        var n, u, d = this, c = d._options, h = d._model, f = d._model = a(c), p = d._active,
                            g = d._data, m = {xAlign: h.xAlign, yAlign: h.yAlign}, v = {x: h.x, y: h.y},
                            b = {width: h.width, height: h.height}, y = {x: h.caretX, y: h.caretY};
                        if (p.length) {
                            f.opacity = 1;
                            var x = [];
                        ...
                        if ("center" === h) s = p + m / 2, "left" === c ? (i = f, a = i - u, r = i, o = s + u, l = s - u) : (i = f + g, a = i + u, r = i, o = s - u, l = s + u); else if ("left" === c ? (a = f + d + u, i = a - u, r = a + u) : "right" === c ? (a = f + g - d - u, i = a - u, r = a + u) : (a = f + g / 2, i = a - u, r = a + u), "top" === h) o = p, s = o - u, l = o; else {
                            o = p + m, s = o + u, l = o;
                            var v = r;
                            r = i, i = v
                        }
                ...
                a.elements.point = {
                    ...
                    inRange: function (t, e) {
                        ...
                        var n = this._view, o = this._model, s = this._chart.ctx, l = n.pointStyle, u = n.radius,
                            d = n.x, c = n.y, h = t.helpers.color, f = 0;
                ...
                i.elements.rectangle = {
                    ...
                    draw: function () {
                        ...
                        if (u.horizontal ? (e = u.base, n = u.x, i = u.y - u.height / 2, a = u.y + u.height / 2, r = n > e ? 1 : -1, o = 1, s = u.borderSkipped || "left") : (e = u.x - u.width / 2, n = u.x + u.width / 2, i = u.y, a = u.base, r = 1, o = a > i ? 1 : -1, s = u.borderSkipped || "bottom"), d) {
                            ...
                            d = d > c ? c : d;
                            var h = d / 2, f = e + ("left" !== s ? h * r : 0), p = n + ("right" !== s ? -h * r : 0),
                                g = i + ("top" !== s ? h * o : 0), m = a + ("bottom" !== s ? -h * o : 0);
            ...
            e.exports = function (t) {
                ...
                function s(t, e, n, i, a, s) {
                    var l, u, d, c, h, f, p, g = e.length, m = i.spanGaps, v = [], b = [], y = 0, x = 0;
                ...
                return t.defaults.global.legend = {
                    ...
                    initialize: function (t) {
                        ...
                        var n = this, a = n.options, r = a.labels, o = a.display, s = n.ctx, l = t.defaults.global,
                            ...
                            f = i.fontString(d, c, h), p = n.legendHitBoxes = [], g = n.minSize, m = n.isHorizontal();
                        if (m ? (g.width = n.maxWidth, g.height = o ? 10 : 0) : (g.width = o ? 10 : 0, g.height = n.maxHeight), o)if (s.font = f, m) {
                            ...
                            var y = r.padding, x = n.columnWidths = [], w = r.padding, k = 0, S = 0, C = d + y;
                        ...
                        if (a.display) {
                            var d, c = n.ctx, h = i.getValueOrDefault, f = h(r.fontColor, o.defaultFontColor),
                                p = h(r.fontSize, o.defaultFontSize), g = h(r.fontStyle, o.defaultFontStyle),
                                m = h(r.fontFamily, o.defaultFontFamily), v = i.fontString(p, g, m);
                            c.textAlign = "left", c.textBaseline = "top", c.lineWidth = .5, c.strokeStyle = f, c.fillStyle = f, c.font = v;
                            var b = e(r, p), y = n.legendHitBoxes, x = function (e, n, i) {
                                if (!(isNaN(b) || b <= 0)) {
                                    ...
                                    if (c.setLineDash && c.setLineDash(h(i.lineDash, s.borderDash)), a.labels && a.labels.usePointStyle) {
                                        var l = p * Math.SQRT2 / 2, u = l / Math.SQRT2, d = e + u, f = n + u;
                            ...
                            d = k ? {x: n.left + (l - u[0]) / 2, y: n.top + r.padding, line: 0} : {
                                x: n.left + r.padding,
                                y: n.top + r.padding,
                                line: 0
                            };
                            ...
                            i.each(n.legendItems, function (t, e) {
                                var i = c.measureText(t.text).width, a = b + p / 2 + i, o = d.x, s = d.y;
                    ...
                    draw: function () {
                        ...
                        if (r.display) {
                            var s, l, u, d = a(r.fontSize, o.defaultFontSize), c = a(r.fontStyle, o.defaultFontStyle),
                                h = a(r.fontFamily, o.defaultFontFamily), f = n.fontString(d, c, h), p = 0, g = e.top,
            ...
            e.exports = function (t) {
                var e = t.helpers, n = {position: "bottom"}, i = t.Scale.extend({
                    getLabels: function () {
                        ...
                        var e = this, n = Math.max(e.ticks.length - (e.options.gridLines.offsetGridLines ? 0 : 1), 1),
                            i = e.isHorizontal(), a = (i ? e.width : e.height) / n;
            ...
            e.exports = function (t) {
                ...
                function n(t) {
                    ...
                    return {size: n, style: i, family: a, font: f.fontString(n, i, a)}
                }
                ...
                function r(t) {
                    ...
                    for (r = 0; r < h; r++) {
                        ...
                        var p = t.getIndexAngle(r), g = f.toDegrees(p) % 360, m = a(g, s.x, o.w, 0, 180),
                ...
                function d(t) {
                    ...
                    for (var g = e(t) - 1; g >= 0; g--) {
                        ...
                        if (d.display) {
                            var v = t.getPointPosition(g, c + 5), b = a(d.fontColor, p.defaultFontColor);
                            i.font = h.font, i.fillStyle = b;
                            var y = t.getIndexAngle(g), x = f.toDegrees(y);
                ...
                var f = t.helpers, p = t.defaults.global, g = {
                    ...
                    setDimensions: function () {
                        ...
                        var i = f.min([t.height, t.width]), a = f.getValueOrDefault(n.fontSize, p.defaultFontSize);
                        ...
                        if (e.display) {
                            var r = t.ctx, o = a(i.fontSize, p.defaultFontSize), s = a(i.fontStyle, p.defaultFontStyle),
                                l = a(i.fontFamily, p.defaultFontFamily), u = f.fontString(o, s, l);
...
WOW.prototype._initStorageVariables = function () {
    ...
    var e = t.getAttribute("data-wow-offset") || this._offset, n = this._getElementOffset(t), i = n + ~~e;
    return i <= window.innerHeight + window.scrollY && (0 === i ? 10 : i) >= window.scrollY
}, WOW.prototype._getElementOffset = function (t) {
    var e = t.getBoundingClientRect(), n = document.body,
        i = window.pageYOffset || document.documentElement.scrollTop || n.scrollTop,
        a = document.documentElement.clientTop || n.clientTop || 0, r = e.top + i - a;
    return Math.round(r)
}, WOW.prototype._checkForChanges = function () {
    var t = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver,
        e = new t(this._mutations.bind(this)), n = {childList: !0, subtree: !0};
    ...
    function r(t) {
        var n, i, a = {top: 0, left: 0}, r = t && t.ownerDocument;
    ...
    function s(t, e, n) {
        if (n) {
            ...
            var i = n.getAttribute("data-x"), a = n.getAttribute("data-y"), r = n.getAttribute("data-scale"),
                s = n.getAttribute("data-translate"), l = Date.now() - Number(n.getAttribute("data-hold")), u = 350 - l;
    ...
    var d = d || {}, c = document.querySelectorAll.bind(document), h = Object.prototype.toString,
    ...
    return d.init = function (t) {
        ...
        t = a(t);
        var n = t.length;
        if (e = e || {}, e.wait = e.wait || 0, e.position = e.position || null, n)for (var i, o, s, l = {}, u = 0, d = {
            type: "mousedown",
            button: 1
        }; u < n; u++)if (i = t[u], o = e.position || {
                    x: i.clientWidth / 2,
                    y: i.clientHeight / 2
                }, s = r(i), l.x = s.left + o.x, l.y = s.top + o.y, d.pageX = l.x, d.pageY = l.y, p.show(d, i), e.wait >= 0 && null !== e.wait) {
            var c = {type: "mouseup", button: 1};
    ...
    t(document).ready(function () {
        var e = ["text", "password", "email", "url", "tel", "number", "search", "search-md"].map(function (t) {
            ...
            if (t.hasClass("validate")) {
                ...
                if (n && i) t.removeClass("valid").removeClass("invalid"); else {
                    var a = t.is(":valid"), r = +t.attr("length") || 0;
        ...
        t(e).each(function (e, i) {
            ...
            var n = t(e.target), a = !n.val(), r = !e.target.validity.badInput, o = void 0 === n.attr("placeholder");
